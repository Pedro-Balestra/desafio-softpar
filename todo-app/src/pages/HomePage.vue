  ...
  <div class="task-edit-container">
    ...
    <div class="task-edit-box">
      ...
      <div class="row q-col-gutter-x-md">
        <q-select v-model="selectedStatus" :options="['Todas', 'Em andamento', 'Concluído', 'Pendente']"
          label="Filtrar por Status" outlined class="q-mt-md col-6" />
        <q-select v-model="selectedOrder" :options="['Mais recente', 'Mais antiga']" label="Ordenar por Data" outlined
          class="q-mt-md col-6" />
      </div>
